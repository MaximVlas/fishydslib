...
- `dc_component_t.value` stores string-valued component responses (for example, radio groups), `dc_component_t.value_bool` stores checkbox boolean responses, and `dc_component_t.values` stores checkbox-group response arrays when `has_values` is set.
