...
static void BM_JSON_Get_Optional_Nullable(benchmark::State& state) {
    ...
    for (auto _ : state) {
        ...
        dc_optional_cstr_t opt_str_val = {0, NULL};
        dc_optional_i64_t opt_i64_val = {0, 0};
        dc_optional_int_t opt_bool_val = {0, 0};
        dc_optional_double_t opt_double_val = {0, 0.0};
        dc_nullable_cstr_t null_str_val = {0, NULL};
        dc_nullable_i64_t null_i64_val = {0, 0};
        dc_nullable_int_t null_bool_val = {0, 0};
        dc_nullable_double_t null_double_val = {0, 0.0};
